...
import (
	...
	"github.com/cosmos/ibc-go/v2/modules/apps/interchain-price/host/keeper"
...
func (im IBCModule) OnChanOpenInit(
	...
	return sdkerrors.Wrap(icptypes.ErrInvalidChannelFlow, "channel handshake must be initiated by controller chain")
}
